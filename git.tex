...
\begin{frame}[fragile]\frametitle{Buenas practicas}
	\begin{figure}
    ...
    \begin{itemize}
      \item Sin comentarios en el commit, hay tabla.
	  \item Features en master, hay tabla.
	  \item Hotfix en el master, hay tabla.	  
	  \item sinasrinasrinasr, hay tabla.
	  \item sinasrinasrinasr, hay tabla.
	  \item sinasrinasrinasr, hay tabla.
	  \item sinasrinasrinasr, hay tabla.
	  \item sinasrinasrinasr, hay tabla.
